...
def get_seq(S):
    ...
    for sample in S.cpu().numpy():  # 遍历每个样本
...
class MyArgs(object):
  def __init__(self):
    ...
    self.path_testset = "dataset/T500/Test50.pt"
    self.path_for_outputs = "test_outputs/test1"
    self.model_path = "/geniusland/home/liaoxuhui/ProteinDesign/DualMPNN/testFolder/full_base_drop_tm/model_weights/epoch70_step94080.pt"
    #--------------------------------------------------------#
    self.num_epochs = 200
